...
app.factory('Episode', [ function(){
  ...
  var episodes = [
    ...
    { title: 'Pilot Episode', number: '1', date: '8/1/17', description: 'Soul Spectrum pilot episode', audioUrl: 'https://archive.org/download/soulspectrumpodcast_gmail_Ep1/ep1.mp3'}
  ];
